...
#define MSC_MAIL_TYPE_INT	  0
#define MSC_MAIL_TYPE_READ	1
#define MSC_MAIL_TYPE_WRITE	2
#define MSC_MAIL_TYPE_MOUNT 3
...
extern struct rt_mailbox MSC_MailBox_Bot;
extern struct rt_mailbox MSC_MailBox_Top;
extern unsigned long MSC_MailPool[2][8];
